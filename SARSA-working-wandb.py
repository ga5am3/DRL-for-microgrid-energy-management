...
wandb.init(project="RL for Microgrid - training", name=f"SARSA-{MEMORY_CAPACITY}-{BATCH_SIZE}")
...
if __name__=="__main__":
  ...
  wandb.init(project="RL for Microgrid - testing", name=f"SARSA-{MEMORY_CAPACITY}-{BATCH_SIZE}")
